...
let handler = async (m, { conn, args, text, usedPrefix, command, isROwner }) => {
    let _p = usedPrefix
    const linkgc = 'https://chat.whatsapp.com/EkJCzjcVoSr0frwzHvkqA4'
    const domain = 'https://client.maximus-fast.store'
    const apikey = 'ptla_rWpE7FNQrEyOQ8cL0YTMc3YNvcOULfdqMTettXLyzWB';
    const c_apikey = 'ptlc_ySjYpP3AylbzSFVFY1P7v8K2trvZUZmTGNd177ZPKxH'
    switch (command) {
        case 'addusr': {
